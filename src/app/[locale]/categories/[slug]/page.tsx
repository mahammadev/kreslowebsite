...
export default async function CategoryPage({ params, searchParams }: { params: Promise<{ locale: string; slug: string }>, searchParams?: Promise<{ [key: string]: string | string[] | undefined }> }) {
