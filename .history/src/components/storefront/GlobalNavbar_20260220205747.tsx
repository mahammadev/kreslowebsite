...
export const GlobalNavbar = async ({ locale }: { locale: string }) => {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 bg-black/95 backdrop-blur-md transition-colors duration-500">
            ...
            <div className="max-w-[1024px] mx-auto px-4 h-11 flex items-center justify-between text-xs font-medium tracking-wide text-zinc-300">
                ...
                <div className="hidden md:flex items-center h-full space-x-8 z-50">
                    ...
                    <div className="h-full flex items-center group">
                        ...
                        {/* Apple-style Animated Curtian Dropdown (Seamless) */}
                        {categories && categories.length > 0 && (
                            <div className="absolute top-11 left-0 w-full bg-black/95 backdrop-blur-md overflow-hidden
                                transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]
                                max-h-0 opacity-0 pointer-events-none border-b border-transparent
                                group-hover:max-h-[600px] group-hover:opacity-100 group-hover:pointer-events-auto group-hover:border-white/10 shadow-2xl">
