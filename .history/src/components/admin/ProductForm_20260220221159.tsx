          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 py-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Product names, categorization, and URLs.</p>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Detailed product information in multiple languages.</p>
              </div>
              <div className="grid gap-6 rounded-lg border p-4 bg-muted/20">
                <div className="grid grid-cols-[1fr_auto] gap-2 items-end">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Cost, stock availability, and visibility.</p>
              </div>
              <div className="grid gap-6 rounded-lg border p-4 bg-muted/20">
                <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex gap-6 pt-2">
                  <FormField control={form.control} name="is_active" render={({ field }) => (
                    <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4 flex-1 bg-background">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Primary product image.</p>
              </div>
                ...
                <FormField control={form.control} name="image_url" render={({ field }) => (
                  <FormItem>
                    <div className="flex flex-col gap-4">
                      {field.value && (
                        <div className="relative h-48 w-full overflow-hidden rounded-md border shadow-sm">
            ...
            <SheetFooter className="flex-row justify-between sm:justify-between pt-6 border-t mt-6">
              {mode === 'edit' ? (
                <Button
                  type="button"
                  variant="destructive"
