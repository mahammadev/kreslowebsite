...
export default async function ProductPage(props: { params: Promise<{ locale: string; slug: string }> }) {
    ...
    return (
        <div className="bg-muted lg:pt-0 pt-16">
            <script
                                    ...
                                    <div className="mt-6 flex flex-col gap-3 w-full border-t pt-6">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {productColors.map((color, idx) => (
                                                <div key={idx} className="px-4 py-2 border border-zinc-200 rounded-md text-sm font-medium bg-zinc-50/50 text-foreground cursor-default hover:border-zinc-300 transition-colors">
                                                    {color}
                                                </div>
                                            ))}
                                        </div>
